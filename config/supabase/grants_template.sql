...
-- Sostituire {{SCHEMA_NAME}} con il nome dello schema specifico
-- 
...
GRANT USAGE ON SCHEMA {{SCHEMA_NAME}} TO anon, authenticated, postgres, public;

-- SELECT su tutte le tabelle esistenti
GRANT SELECT ON ALL TABLES IN SCHEMA {{SCHEMA_NAME}} TO anon, authenticated, postgres, public;
...
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA {{SCHEMA_NAME}} TO anon, authenticated, postgres, public;
...
GRANT INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA {{SCHEMA_NAME}} TO anon, authenticated;
ALTER DEFAULT PRIVILEGES IN SCHEMA {{SCHEMA_NAME}}
