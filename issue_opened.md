...
| **ARCH-003** | 🏗️ Architettura | **Database Segregation Non Configurata** | Database unico invece di 5 database segregati per microservizio | **8** | 🔴 CRITICO | 🟡 MEDIO | 🚫 OPEN | Struttura e documentazione dei database separati completata per ogni microservizio, aggiunte viste aggregate per dashboarding, link diretto alla documentazione nel README |
