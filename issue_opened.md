...
| **ARCH-003** | 🏗️ Architettura | **Database Segregation Non Configurata** | Database unico invece di 5 database segregati per microservizio | **8** | 🔴 CRITICO | 🟡 MEDIO | 🚫 OPEN | Definire e documentare la struttura dei database separati, aggiornare config |
