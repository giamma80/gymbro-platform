...
class IUcalorieUbalanceRepository(ABC):
    ...
    ) -> Optional[UcalorieUbalanceEntity]:
        """
...
class IUcalorieUbalanceDomainService(ABC):
    ...
    @abstractmethod
    async def validate_calorie_balance_data(
...
class IEventPublisher(ABC):
    ...
    @abstractmethod
    async def publish_calorie_balance_created(
        self, entity: UcalorieUbalanceEntity
    ) -> None:
        """
    ...
    @abstractmethod
    async def publish_calorie_balance_updated(
        self, entity: UcalorieUbalanceEntity
    ) -> None:
        """
    ...
    @abstractmethod
    async def publish_calorie_balance_deleted(
