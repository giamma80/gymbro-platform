...
from app.graphql.types import UcalorieUbalanceType, UcalorieUbalanceResponse, CreateUcalorieUbalanceInput, UpdateUcalorieUbalanceInput
...
class Mutation:
    ...
    @strawberry.mutation
    async def create_calorie_balance(self, input: CreateUcalorieUbalanceInput) -> UcalorieUbalanceResponse:
        ...
        try:
            ...
            if not created_data:
                return UcalorieUbalanceResponse(
                    success=False,
                    message="Failed to create calorie_balance",
                    data=None
                )
    ...
    async def update_calorie_balance(
        ...
        try:
            ...
            if not updated_data:
                return UcalorieUbalanceResponse(
                    success=False,
                    message="Failed to update calorie_balance",
                    data=None
                )
    ...
    @strawberry.mutation
    async def delete_calorie_balance(self, id: strawberry.ID) -> UcalorieUbalanceResponse:
        ...
        try:
            ...
            return UcalorieUbalanceResponse(
                success=True,
                message="Successfully deleted calorie_balance",
                data=None
            )
