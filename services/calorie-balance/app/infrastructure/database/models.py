...
class UserModel(Base):
    ...
    calorie_goals = relationship(
        "CalorieGoalModel", back_populates="user", cascade="all, delete-orphan"
    )
    daily_balances = relationship(
        "DailyBalanceModel", back_populates="user", cascade="all, delete-orphan"
    )
    metabolic_profiles = relationship(
        "MetabolicProfileModel", back_populates="user", cascade="all, delete-orphan"
    )
