...
class UserRepository:
    ...
    def _map_to_entity(self, data: Dict[str, Any]) -> User:
        ...
        return User(
            ...
            email_verified_at=datetime.fromisoformat(data["email_verified_at"]) if data["email_verified_at"] else None,
            created_at=datetime.fromisoformat(data["created_at"]) if data["created_at"] else None,
            updated_at=datetime.fromisoformat(data["updated_at"]) if data["updated_at"] else None,
            last_login_at=datetime.fromisoformat(data["last_login_at"]) if data["last_login_at"] else None,
        )
...
class UserProfileRepository:
    ...
    async def create(self, profile: UserProfile) -> UserProfile:
        ...
        try:
            ...
            logger.error("Failed to create user profile", user_id=profile.user_id, error=str(e))
            raise
    ...
    async def update(self, profile: UserProfile) -> UserProfile:
        ...
        try:
            ...
            result = self.table.update(data).eq("user_id", str(profile.user_id)).execute()
            ...
            logger.error("Failed to update user profile", user_id=profile.user_id, error=str(e))
            raise
...
class PrivacySettingsRepository:
    ...
    async def create(self, settings: PrivacySettings) -> PrivacySettings:
        ...
        try:
            data = {
                ...
                "consent_given_at": settings.consent_given_at.isoformat() if settings.consent_given_at else None,
            ...
            logger.error("Failed to create privacy settings", user_id=settings.user_id, error=str(e))
            raise
    ...
    async def update(self, settings: PrivacySettings) -> PrivacySettings:
        ...
        try:
            ...
            result = self.table.update(data).eq("user_id", str(settings.user_id)).execute()
            ...
            logger.error("Failed to update privacy settings", user_id=settings.user_id, error=str(e))
            raise
    ...
    def _map_to_entity(self, data: Dict[str, Any]) -> PrivacySettings:
        ...
        return PrivacySettings(
            ...
            preferences=data.get("preferences", {}),
            consent_given_at=datetime.fromisoformat(data["consent_given_at"]) if data.get("consent_given_at") else None,
            updated_at=datetime.fromisoformat(data["updated_at"]) if data.get("updated_at") else None,
        )
...
class UserServiceContextRepository:
    ...
    async def get_by_user_id(self, user_id: UUID) -> Optional[UserServiceContext]:
        ...
        try:
            ...
            logger.error("Failed to get user service context", user_id=user_id, error=str(e))
            raise
    
    async def list_active_contexts(self, limit: int = 100, offset: int = 0) -> List[UserServiceContext]:
