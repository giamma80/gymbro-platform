...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    logger.info("Service startup complete", database="user_management schema")
...
def create_application() -> FastAPI:
    ...
    app = FastAPI(
        title="NutriFit user-management",
        description="NutriFit user-management microservice with Supabase integration",
        version="1.0.0",
