...
-- Sostituire user_management con il nome dello schema specifico
-- 
...
GRANT USAGE ON SCHEMA user_management TO anon, authenticated, postgres, public;

-- SELECT su tutte le tabelle esistenti
GRANT SELECT ON ALL TABLES IN SCHEMA user_management TO anon, authenticated, postgres, public;
...
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA user_management TO anon, authenticated, postgres, public;
...
GRANT INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA user_management TO anon, authenticated;
ALTER DEFAULT PRIVILEGES IN SCHEMA user_management
