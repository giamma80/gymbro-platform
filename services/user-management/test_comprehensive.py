...
class UserManagementTests:
    ...
    def log_section(self, section_name: str):
        ...
        print(f"\n{TestColors.BLUE}{TestColors.BOLD}📋 "
              f"{section_name}{TestColors.END}")
    ...
    def get(self, endpoint: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "error": (response.text if response.status_code != 200
                         else None)
            }
    ...
    def test_profile_endpoints(self):
        ...
        self.log_test(
            "Get User Profile",
            result["status_code"] == 200 and result["data"]["display_name"] == "Test User",
        ...
        self.log_test(
            "Update User Profile",
            result["status_code"] == 200 and result["data"]["display_name"] == "Updated Test User",
    ...
    def test_user_actions(self):
        ...
        self.log_test(
            ...
            result["status_code"] == 200 and "already verified" in result["data"]["message"].lower(),
        ...
        self.log_test(
            "Record User Login",
            result["status_code"] == 200 and "login recorded" in result["data"]["message"].lower(),
    ...
    def test_data_validation(self):
        ...
        invalid_data = {
            "date_of_birth": "2020-01-01"  # Too young (< 13 years)
        }
    ...
    def generate_summary(self):
        ...
        print(f"Success Rate: {TestColors.CYAN}{(self.passed/self.total*100):.1f}%{TestColors.END}")
