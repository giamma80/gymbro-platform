...
===============================
Template for CRUD operations on main entities for {service-name} service.
...
Example entities:
- User management service: Users, profiles, settings
...
router = APIRouter(prefix="/{service-name-kebab}", tags=["{service-name} Entities"])
...
async def update_entity(
    ...
    try:
        ...
        result = supabase.table("entities").update(update_data).eq("id", entity_id).execute()
